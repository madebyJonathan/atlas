...
const serviceLinks = ["Residential", "Commercial", "Renovations", "Consulting", "Careers"];

export default function Footer() {
  return (
    <footer className="w-full bg-[#1a1a1a] flex flex-col gap-12 md:gap-20 px-4 md:px-16 py-12 md:py-20">
      {/* Main Content */}
      <div className="flex flex-col md:flex-row gap-10 md:gap-16 w-full">
        ...
        <div className="flex-1 flex flex-col gap-6 md:gap-8">
          ...
          <div className="flex flex-col gap-1 w-full">
            <span className="font-mono text-sm font-semibold leading-[1.5] text-[#ecece3]">Address:</span>
          ...
          <div className="flex flex-col gap-1 w-full">
            <span className="font-mono text-sm font-semibold leading-[1.5] text-[#ecece3]">Contact:</span>
            <span className="font-mono text-sm leading-[1.5] text-[#ecece3aa]">+1 (555) 234-5678</span>
            <span className="font-mono text-sm leading-[1.5] text-[#ecece3aa]">info@atlasconstruction.com</span>
          </div>
        ...
        <div className="flex-1 flex gap-6">
          <div className="flex-1 flex flex-col">
            {navLinks.map((link) => (
              <a key={link} href="#" className="font-mono text-sm font-semibold leading-[1.5] text-[#ecece3] py-2 hover:opacity-70 transition-opacity">
                {link}
              </a>
            ))}
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-4 md:gap-6">
            {["Privacy Policy", "Terms of Service", "Cookies Settings"].map((item) => (
              <a key={item} href="#" className="font-mono text-sm leading-[1.5] text-[#ecece3aa] hover:text-[#ecece3] transition-colors">
                {item}
              </a>
            ))}
          </div>
